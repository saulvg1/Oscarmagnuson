!(function (e) {
	function t(t) {
		for (var n, a, s = t[0], c = t[1], l = t[3] || [], d = 0, f = []; d < s.length; d++)
			(a = s[d]), Object.prototype.hasOwnProperty.call(i, a) && i[a] && f.push(i[a][0]), (i[a] = 0);
		...
		!(function (t, n) {
			var i = (function (e, t, n) {
				...
				var o = t.documentElement,
					...
					m = function (e, t) {
						return (
							h[t] || (h[t] = new RegExp("(\\s|^)" + t + "(\\s|$)")), h[t].test(e.getAttribute("class") || "") && h[t]
						);
					},
					v = function (e, t) {
					...
					A =
						...
						(Z = function (e, n) {
							var i,
								r = e,
								a = K(e);
							for ($ -= n, H += n, R -= n, B += n; a && (r = r.offsetParent) && r != t.body && r != o; )
								(a = (_(r, "opacity") || 1) > 0) &&
									...
									if (v[n] && !v[n]._lazyRace)
										if (!Y || (i.prematureUnveil && i.prematureUnveil(v[n]))) se(v[n]);
											...
											!c &&
												...
												(z[0] || (!d && (H || B || R || $ || "auto" != v[n].getAttribute(r.sizesAttr)))) &&
												(s = z[0] || v[n]);
								s && !c && se(s);
							}
						}),
						(te = (function (e) {
							...
							return function (e) {
								var r;
								(e = !0 === e) && (a = 33),
									t || ((t = !0), (r = o - (n.now() - i)) < 0 && (r = 0), e || r < 9 ? u() : c(u, r));
							};
						})(ee)),
						(ne = function (e) {
							var t = e.target;
							t._lazyCache
								? delete t._lazyCache
								: (Q(e), v(t, r.loadedClass), y(t, r.loadingClass), g(t, re), b(t, "lazyloaded"));
						}),
						(ie = x(ne)),
						(re = function (e) {
							ie({ target: e.target });
						...
						(oe = function (e) {
							...
							(t = r.customMedia[e.getAttribute("data-media") || e.getAttribute("media")]) &&
							...
							_: function () {
								(M = n.now()),
									...
									/d$|^c/.test(t.readyState)
										? le()
										: (s("load", le), t.addEventListener("DOMContentLoaded", te), c(le, 2e4)),
					...
					k =
						((L = x(function (e, t, n, i) {
							...
							if (((e._lazysizesWidth = i), (i += "px"), e.setAttribute("sizes", i), d.test(t.nodeName || "")))
								for (o = 0, a = (r = t.getElementsByTagName("source")).length; o < a; o++)
						...
						(P = function (e, t, n) {
							...
							r &&
								((n = E(e, r, n)),
								(i = b(e, "lazybeforesizes", { width: n, dataAttr: !!t })).defaultPrevented ||
									((n = i.detail.width) && n !== e._lazysizesWidth && L(e, r, i, n)));
						}),
						(T = O(function () {
							var e,
								t = I.length;
					...
					C = function () {
						!C.i && t.getElementsByClassName && ((C.i = !0), k._(), A._());
					};
				var I, L, P, T;
				var z, j, N, D, M, q, F, $, R, B, H, U, V, W, Y, J, X, G, Q, K, Z, ee, te, ne, ie, re, oe, ae, se, ce, ue, le;
				var de, fe, he, pe, me, ve, ye;
				return (
					c(function () {
						r.init && C();
					}),
					(i = { cfg: r, autoSizer: k, loader: A, init: C, uP: w, aC: v, rC: y, hC: m, fire: b, gW: E, rAF: S })
				);
			})(t, t.document, Date);
				...
				return (() => {
					...
					var e = {
							311: (e, t, n) => {
								...
								n.r(i),
									n.d(i, { CREATED: () => R, DESTROYED: () => V, IDLE: () => H, MOUNTED: () => B, MOVING: () => U });
								var o = Object.keys;
								function a(e, t) {
								...
								function m(e, t) {
									if ("string" == typeof t) {
										var n = b("div", {});
										x(n, { position: "absolute", width: t }), E(e, n), (t = n.clientWidth), _(n);
									}
									return +t || 0;
								}
								function v(e, t) {
								...
								const j = function (e, t) {
									...
									N = function (e, t) {
										function n(n) {
											var i = e.options;
											x(t.Elements.slides[n], { transition: "opacity " + i.speed + "ms " + i.easing });
										}
										return {
											mount: function () {
												n(e.index);
								...
								var Y = (function () {
									...
									return (
										...
										(o.add = function (e, t) {
											return (
												void 0 === t && (t = -1), this.Components.Elements.add(e, t, this.refresh.bind(this)), this
											);
										}),
										(o.remove = function (e) {
											...
											register: function (t, n, i) {
												var o = (function (e, t, n, i) {
													...
													function c(t, n) {
														...
														t
															? (A(i, o), e.emit("" + r, a))
															: C(i, o) && (k(i, o), e.emit(n ? "hidden" : "inactive", a));
													}
													function u() {
														I(i, "style", a.styles);
													}
								...
								const Z = function (e, t) {
										var n,
											...
											l = {
												...
												translate: function (e) {
													x(r, { transform: "translate" + (o ? "Y" : "X") + "(" + e + "px)" });
												},
												cancel: function () {
													e.is(z) ? this.shift() : this.translate(this.position), x(r, { transition: "" });
												},
												shift: function () {
										...
										function f(t, n, i, o) {
											x(r, { transition: "" }), (c = !1), a || l.jump(n), o || e.emit("moved", n, i, t);
										}
										function h(e) {
														...
														return {
															...
															resize: function () {
																...
																var t = i.padding,
																	a = m(o, t.top || t),
																	s = m(o, t.bottom || t);
																(this.padding = { top: a, bottom: s }), x(n, { paddingTop: h(a), paddingBottom: h(s) });
															},
														...
														return {
															...
															resize: function () {
																...
																var t = o.padding,
																	a = m(r, t.left || t),
																	s = m(r, t.right || t);
																(this.padding = { left: a, right: s }), x(n, { paddingLeft: h(a), paddingRight: h(s) });
															},
														...
														if (r > 0) {
															...
															if (!e.is("fade")) {
																...
																r > o.flickVelocityThreshold &&
																	...
																	(h += u * Math.min(r * o.flickPower, t.Layout.size * (o.flickMaxPages || 1))),
																	(f = s.toIndex(h));
															}
									...
									le = function (e, t, n) {
										...
										function a(t, r) {
											var a = o.getItem(r),
												s = o.getItem(t),
												c = F.active;
											a && k(a.button, c), s && A(s.button, c), e.emit(n + ":updated", i, a, s);
										}
										return o;
									};
								var de = {
								...
								var he = [" ", "Enter", "Spacebar"],
									pe = {
													...
													mount: function () {
														...
														o.slides.length > t.perPage &&
															((i = (function (e, t, n) {
																...
																t.interval,
																function (t) {
																	e.emit(n + ":playing", t), o.bar && x(o.bar, { width: 100 * t + "%" });
																}
															)),
															(function () {
																var t = e.options,
										...
										Cover: function (e, t) {
											...
											function i(e, t) {
												x(e.parentElement, { background: t ? "" : 'center/cover no-repeat url("' + e.src + '")' }),
													x(e, { display: t ? "" : "none" });
											}
											return {
										...
										LazyLoad: function (e, t, n) {
											...
											function f(t, i, r, o) {
												k(r.slide, F.loading),
													o || (_(i), x(t, { display: "" }), e.emit(n + ":loaded", t).emit("resize")),
													s && d();
											}
											return {
												required: o.lazyLoad,
													...
													e.on("mounted refresh", function () {
														c(),
															t.Elements.each(function (e) {
																a(
																	e.slide.querySelectorAll("[data-splide-lazy], [data-splide-lazy-srcset]"),
																	function (t) {
																		t.src || t.srcset || (r.push({ img: t, Slide: e }), x(t, { display: "none" }));
																	}
																);
															}),
															s && d();
					...
					return (
						...
						new Proxy(e, {
							...
							set: function (e, n, i, r) {
								...
								var u = e[n];
								return (
									(e[n] = i), o(u) || o(u.__watchers) || (e[n].__watchers = u.__watchers), t.set(e, n, e[n], r), !0
								);
							},
						})
					);
				...
				u = {
					...
					start: function () {
						...
						this.startingCallbacks.forEach(function (e) {
							...
							(this.stores = c(this.stores, {
								get: function (t, n, i) {
									return Object.is(i, e.stores) && ["get", "set", "toggle", "call", "clear"].includes(n)
										? e[n].bind(e)
										: Reflect.get(t, n, i);
								},
					...
					attach: function () {
						if (
							!(
								...
								(window.Alpine && r.compare(window.Alpine.version, "2.7.0", ">="))
							)
						)
					...
					set: function (e, t, n) {
						return (
							...
							s(e) || (e = e.split(".")),
							1 === e.length ? (n[e[0]] = t) : (n[e[0]] || (n[e[0]] = {}), this.set(e.slice(1), t, n[e[0]]))
						);
					},
					toggle: function (e) {
								...
								"self" != n &&
									(i =
										"prev" == n
											...
											: (n && (r.closest || e.jQuery) && (r.closest ? r.closest(n) : jQuery(r).closest(n)[0])) || r),
								i
							);
						},
						getFit: function (e) {
							...
							return (
								...
								s.fit
									? (!(n = e._lazysizesParentContainer || e.getAttribute("data-parent-container")) &&
											a &&
											(t = a.match(o)) &&
											(n = t[1]),
									...
									(c = parseFloat(t.getAttribute("data-aspectratio"))) ||
										((u = r.match(i))
											? "w" == u[2]
												? ((l = u[1]), (d = u[3]))
												: ((l = u[3]), (d = u[1]))
											: ((l = t.getAttribute("width")), (d = t.getAttribute("height"))),
										(c = l / d));
									break;
								}
							return c;
			...
			function b(e, n, o) {
				...
				if (e) {
					if ("container" === n.ratio) {
						for (s = f.scrollWidth, c = f.scrollHeight; !((s && c) || f === t); )
						...
						if (
							...
							if (
								((a = (function (e, t) {
									var i = g(e, t);
									return (
										r.modifyOptions.call(e, { target: e, details: i, detail: i }),
								...
								for (l = 0, d = (c = s.getElementsByTagName("source")).length; l < d; l++)
									(v || u.test((f = w(c[l])))) && (b(f, g(c[l], f, a), c[l]), (E = !0));
							v || u.test(o)
								? (b(o, a, t), (E = !0))
								: E &&
								  (((S = []).srcset = []),
								  (S.isPicture = !0),
								  Object.defineProperty(t, "_lazyrias", { value: S, writable: !0 })),
								E &&
									(y
										? t.removeAttribute(i.srcAttr)
										: "auto" != p && ((m = { width: parseInt(p, 10) }), _({ target: t, detail: m })));
						}
					},
					!0
				);
					...
					a = function (e, t) {
						...
						return (
							!e._lazyrias &&
								...
								(Object.defineProperty(e, "_lazyrias", { value: r, writable: !0 }),
						...
						if ((l = t._lazyrias).isPicture && e.matchMedia)
							for (s = 0, c = (o = t.parentNode.getElementsByTagName("source")).length; s < c; s++)
								if (
									...
									(!(u = o[s].getAttribute("media")) || (matchMedia(u) || {}).matches)
								) {
									l = o[s]._lazyrias;
									break;
								}
							...
							n._lazybgset && n._lazybgset.parentNode == n && n.removeChild(n._lazybgset),
								...
								e.forEach(function (e) {
									...
									u && "auto" != u && r.setAttribute("sizes", u),
										(n = e.match(a))
											? (r.setAttribute(i.srcsetAttr, n[1]), l(r, n[2]), l(r, n[3]))
	...
	function (e, t, n) {
		...
		!(function (a, s) {
					...
					function () {
						var e = t.createElement("img"),
							i = function (e) {
								...
								i &&
									(n = i.match(r)) &&
									((t = "w" == n[2] ? n[1] / n[3] : n[3] / n[1]) && e.setAttribute("data-aspectratio", t),
			...
			e.HTMLPictureElement && _)
				? !n.hasHDescriptorFix && t.msElementsFromPoint && ((n.hasHDescriptorFix = !0), S())
				: e.picturefill ||
				  b.pf ||
				  ((b.pf = function (t) {
						var n, r;
				  ...
				  (p = function (t, i) {
						...
						!o &&
							i &&
							(o = t._lazypolyfill ? t._lazypolyfill._set : t.getAttribute(b.srcAttr) || t.getAttribute("src")),
							(t._lazypolyfill && t._lazypolyfill._set == o) ||
								((r = f(o || "")),
								i &&
									t.parentNode &&
									((r.isPicture = "PICTURE" == t.parentNode.nodeName.toUpperCase()),
									r.isPicture && e.matchMedia && (n.aC(t, "lazymatchmedia"), h())),
								(r._set = o),
	...
	function (e, t, n) {
		e.exports = (function () {
			...
			function C(e) {
				...
				return (
					o
						? ((i.item = r.replace(t, "").trim()), (i.index = o[1].trim()), o[2] && (i.collection = o[2].trim()))
						: (i.item = r),
					i
				);
			}
				...
				if ("value" === n) {
					...
					if ((void 0 === l && r.match(/\./) && (l = ""), "radio" === t.type))
						...
						"boolean" == typeof l || [null, void 0].includes(l) || "bind" !== c
							? "bind" !== c && (Array.isArray(l) ? (t.checked = l.some((e) => o(e, t.value))) : (t.checked = !!l))
							: (t.value = String(l));
				...
				if ((i.includes("camel") && (n = s(n)), i.includes("away"))) {
					let s = (c) => {
						t.contains(c.target) ||
							...
							(T(e, r, c, o), i.includes("once") && document.removeEventListener(n, s, a));
					};
					...
					(n, i) => {
						...
						if ("select" === e.tagName.toLowerCase() && e.multiple)
							return t.includes("number")
								? Array.from(n.target.selectedOptions).map((e) => N(e.value || e.text))
						...
						t.watchers[i]
							...
							: Object.keys(t.watchers)
									...
									.forEach((n) => {
										...
										i === r[r.length - 1] &&
											r.reduce(
												(r, o) => (Object.is(e, r) && t.watchers[n].forEach((t) => t(e[i])), r[o]),
												t.unobservedData
											);
									}),
							t.pauseReactivity || n();
								...
								!(function (e, t, i, r, o) {
									var a =
										"select" === t.tagName.toLowerCase() || ["checkbox", "radio"].includes(t.type) || i.includes("lazy")
											? "change"
											: "input";
									P(e, t, a, i, `${r} = rightSideOfExpression($event, ${r})`, () =>
							...
							if (n && n.isSameNode(this.$el)) {
								...
								e[t].addedNodes.length > 0 &&
									e[t].addedNodes.forEach((e) => {
										1 !== e.nodeType ||
											e.__x_inserted_me ||
											(!e.matches("[x-data]") || e.__x ? this.initializeElements(e) : (e.__x = new pe(e)));
									});
							}
						}
		...
		!(function () {
			...
			function u(e, t, n) {
				if (e.nodeType == Node.ELEMENT_NODE) {
					...
					if ("slot" == i.localName) {
						for (var c = i, l = c.assignedNodes ? c.assignedNodes({ flatten: !0 }) : [], d = 0; d < l.length; d++)
							u(l[d], t, n);
						return;
					}
				}
				...
				mounted: function () {
					...
					this.$watch("state", function () {
						...
						this.$nextTick(function () {
							("#recover" === window.location.hash || document.querySelector("[data-recover-success]")) &&
								(e.state = "recover");
	...
	function (e, t, n) {
			...
			a(),
				...
				(r.keydown = function (t) {
					9 === t.keyCode &&
						...
						(t.target !== e && t.target !== s) || !t.shiftKey || (t.preventDefault(), c.focus()));
				}),
		...
		n(16),
			Spruce.store("availability", {
				...
				getVariantTitle: function () {
					return this.current_variant && this.current_variant.title && !this.current_variant.title.includes("Default")
		...
		var h = (function () {
			const e = "link",
				...
				o = {
					...
					plyrShopifyStyles: { tagId: "plyr-shopify-styles", src: r + "plyr/v2.0/shopify-plyr.css", type: e },
					shopifyXr: {
			...
			(window.ThemeComponent_Video = function (e, t, n, i) {
				return {
					...
					dispatchPauseEvent: function () {
						document.body.dispatchEvent(new CustomEvent("pauseAllMedia", { detail: { id: this.id } }));
					},
					pause: function () {
						if (!this.enabled) return !1;
						if ("video" === this.type) this.$refs.video_container.querySelector("video").pause();
						else
							switch (this.host) {
								case "youtube":
					...
					play: function () {
						if (!this.enabled) return !1;
						if ("video" === this.type) this.$refs.video_container.querySelector("video").play();
						else
							switch (this.host) {
								case "youtube":
		...
		function y(e, t) {
			...
			return (n.constructor = p), (n.prototype = Object.create(p.prototype)), (n.prototype.type = e), (m[e] = n);
		}
		function g(e, t) {
			(e = _(e)),
					...
					void 0 !== n &&
						(t = t.filter(function (t) {
							return (
								...
								(t.getAttribute("data-section-type") !== e || (v.push(new n(t)), !1))
							);
						}));
				});
		}
				...
				(function (e, t) {
					...
					try {
						for (
							...
							!(i = (a = s.next()).done) && (n.push(a.value), !t || n.length !== t);
							i = !0
						);
					} catch (e) {
						(r = !0), (o = e);
		...
		function C(e, t) {
			...
			return (
				(t = t || {}),
				(n.method = "POST"),
				(n.body = JSON.stringify({ line: e, quantity: t.quantity, properties: t.properties })),
				A("/cart/change.js", n)
			);
		}
		function I(e) {
			var t = O();
			return (t.method = "POST"), (t.body = JSON.stringify(e)), A("/cart/update.js", t);
		}
		function L(e) {
		...
		function N(e) {
			...
			return (
				...
				(function (e) {
					var t = O();
					return delete t.headers["Content-Type"], (t.method = "POST"), (t.body = e), A("/cart/add.js", t);
				})(t)
			);
		}
			...
			onLoad: function () {
				...
				window.ThemeSection_cartDrawer = function () {
					return {
						...
						updating: !1,
						noteUpdating: !1,
						getSizedImageUrl: M.getSizedImageUrl,
						mounted: function () {
							var n = this;
								...
								this.$watch("state", function (e) {
									e &&
										...
										document.body.dispatchEvent(
											new CustomEvent("baseline:modalcart:itemcountupdate", { detail: { count: e.item_count } })
										));
								}),
						...
						qtyAdjust: function (e, t) {
							if (!this.updating) {
								...
								"plus" === n && t.quantity++,
									"minus" === n && (t.quantity--, t.quantity <= 0 && (t.quantity = 0)),
									...
									n
										? (!(function (e) {
										  ...
										  e.quantity > n.quantity &&
												alert(window.theme.strings.cartAddError.replace("{{ title }}", n.title)))
										: 0 === e.quantity &&
						...
						getCartImgSrcset: function (e) {
							return (function (
								e,
								t = [180, 360, 540, 720, 900, 1080, 1296, 1512, 1728, 1944, 2160, 2376, 2592, 2808, 3024]
							) {
								if (!e) return;
								const n = [];
								return (
				...
				H(e),
					(function (e) {
						...
						if ("string" != typeof e[0].name)
							throw new TypeError(
								"Invalid value type passed for name of option " + e[0].name + ". Value should be string."
							);
					})(t);
				var n = [];
				return (
		...
		function X(e, t, n) {
			(this.element = e),
				...
				(this.propertyInputs = this._initInputs(J, n.onPropertyChange));
		}
		(X.prototype.destroy = function () {
			...
			(X.prototype._setIdInputValue = function (e) {
				...
				t || (((t = document.createElement("input")).type = "hidden"), (t.name = "id"), this.element.appendChild(t)),
					(t.value = e.toString());
			}),
		...
		var Z = (function () {
			...
			function s(e) {
				...
				e.container.addEventListener("mediaVisible", function () {
					t.element.setAttribute("data-shopify-model3d-id", e.modelId), u.isTouch() || e.modelViewerUi.play();
				}),
					...
					(e.prototype = Object.assign({}, e.prototype, {
						fetchContent: function (e) {
							if (!window.Spruce.store("availability").availability[e.id]) {
								const t = this.container.dataset.baseUrl + "/variants/" + e.id + "/?section_id=store-availability";
								return (
		...
		y("product", {
			onLoad: function () {
				...
				if (this.container.querySelector("[data-product-json]")) {
					(this.productSingleObject = JSON.parse(this.container.querySelector("[data-product-json]").innerHTML)),
						...
						r && (this.storeAvailability = new ee(r)),
						(this.sectionId = this.id),
						...
						(window["ThemeSection_" + i] = function () {
							return {
								...
								optionChange: function () {
									this.getOptions();
									var e = B(this.product, this.options);
									if (((this.current_variant = e), this.current_variant)) {
										$(this.current_variant),
											...
											// 		("swap" == s ? this.swapVariantImage() : this.scrollToVariantImage());
											// var t = (function (e, t) {
											...
											this.$refs.singleVariantSelector.dispatchEvent(new Event("change", { bubbles: !0 }));
									}
								},
								getOptions: function () {
									var e = this;
									(this.options = []),
										...
										this.$el.querySelectorAll("[data-single-option-selector]").forEach(function (t) {
											if ("SELECT" === t.nodeName) {
												var n = t.value;
												e.options.push(n), e.optionHandles.push(t.options[t.selectedIndex].dataset.handle);
											} else if (t.checked) {
												var i = t.value;
												e.options.push(i), e.optionHandles.push(t.dataset.handle);
											}
										});
								},
								...
								scrollToVariantImage: function () {
									var e = document.getElementById("shopify-section-header").querySelector('[data-sticky="true"]'),
										n = 0;
									null !== e && (n = e.clientHeight), (this.current_media_id = this.current_variant.featured_media.id);
								...
								openZoom: function (e) {
									...
									i.init(), o(t.pswpElement), (document.documentElement.style.overflowY = "hidden");
			...
			calculateSlideshowHeight: function () {
				...
				if (this.slides && this.slides.classList.contains("is-active")) {
					var t = this.splideContainer.Components.Elements.getSlide(this.splideContainer.index).slide.querySelector(
					...
					this.slides &&
						...
						e &&
							(this.slideshowSettings = {
								...
								breakpoints: { 1024: { type: "slide", perPage: 1, autoWidth: !1 } },
							}),
						(this.splideContainer = new Q.a(this.slides, this.slideshowSettings)),
						this.splideContainer.mount({ SplideProduct: oe }),
					...
					if (i.length) {
						...
						for (var u = 0, l = o; u < l.length; u++) {
							var d = l[u],
								...
								m = d.aspectRatio,
								v = d.alt || null,
								y = { src: Object(M.getSizedImageUrl)(f, "".concat(1400, "x")), w: 1400, h: 1400 / m, alt: v };
							this.mobilePswpItems.push(y);
							var g = "",
								b = 0,
								w = 0;
							if (h <= 3e3) (g = f), (b = h), (w = p);
							else (g = Object(M.getSizedImageUrl)(f, "".concat(3e3, "x"))), (b = 3e3), (w = 3e3 / m);
			...
			onLoad: function () {
				...
				if (null !== e) {
					var t = e.dataset.baseUrl,
						...
						r = e.dataset.limit,
						o = "".concat(t, "?section_id=").concat(i, "&limit=").concat(r, "&product_id=").concat(n),
		...
		y("slideshow", {
			onLoad: function () {
				(this.flag = 99),
					...
					(this.splideContainer = new Q.a(this.slides, {
						perPage: 1,
						type: "loop",
						pagination: !0,
						arrows: !0,
			...
			bindEvents: function () {
				...
				this.container.addEventListener("click", function (t) {
					...
					this.splideContainer.on("mounted moved", function () {
						if ((K(e.splideContainer), e.paginationClicked)) {
							e.paginationClicked = !1;
			...
			setUpPlayButton: function () {
				...
				if (this.autoplayControl) {
					...
					this.splideContainer.on("autoplay:play", function () {
						e.autoplayControl.classList.remove(t), e.autoplayControl.setAttribute("aria-label", i);
					}),
						this.splideContainer.on("autoplay:pause", function () {
							e.autoplayControl.classList.add(t), e.autoplayControl.setAttribute("aria-label", n);
						}),
		...
		y("footer", {
			onLoad: function () {
				(this.selectors = {
					...
					(this.cache = {}),
					this.cacheSelectors(),
					this.cache.localeDisclosure && (this.localeDisclosure = new ae(this.cache.localeDisclosure)),
					this.cache.currencyDisclosure && (this.currencyDisclosure = new ae(this.cache.currencyDisclosure));
			},
						...
						t.forEach(function (t) {
							t.isIntersecting
								? t.target.dispatchEvent(
										new CustomEvent(e + ":video-component:visible", { bubbles: !1, cancelable: !1 })
								  )
								: t.target.dispatchEvent(
										new CustomEvent(e + ":video-component:not-visible", { bubbles: !1, cancelable: !1 })
								  );
						});
					}),
					...
					(n = [
						...
						},
						{
							...
							value: function (e) {
								...
								"" !== t && (console.error(t), Shopify.designMode && this._showErrorMessage(t)),
						...
						},
						{
							...
							value: function () {
								!0 === this.YTReady
									? this._play()
									: ((this.YTReady = !0), this._initResponsiveVideoContainer(), this._initVideoContainerObserver());
							},
						},
						{
							key: "_initYTVideo",
							value: function () {
								(ue[this.playerId] = new YT.Player(this.playerId, {
						...
						},
						{
							...
							value: function () {
								"youtube" === this.videoProvider
									? !0 === this.YTReady && ue[this.playerId].pauseVideo()
						...
						},
						{
							...
							value: function () {
								...
								if (
									(e.classList.remove(this.classes.tallIframeClass), (e.style.width = ""), (e.style.left = ""), n < t)
								) {
						...
						},
						{
							...
							value: function () {
								void 0 === window.Baseline._videoComponentObserver &&
									(window.Baseline._videoComponentObserver = new se()),
		...
		y("video-with-text-overlay", {
			onLoad: function () {
				...
				e && (this.backgroundVideo = new le(e));
			},
			onBlockDeselect: function () {},
			onUnload: function () {},
		}),
					...
					window.ThemeSection_collection = function () {
						return {
							...
							mounted: function () {
								...
								document.addEventListener("keyup", function (e) {
									"Escape" === e.key &&
										(t.filtersOpen && ((t.filtersOpen = !1), t.$refs.filter.focus()),
							...
							renderSectionFromFetch: function (e, t) {
								...
								fetch(e)
									...
									.then(function (i) {
										var r = i;
										(n.filterData = [].concat(de(n.filterData), [{ html: r, url: e }])),
											n.renderFilters(r, t),
					...
					return {
							...
							document.addEventListener("keyup", function (t) {
								...
								"/challenge" !== window.location.pathname &&
									...
									this.$refs["form-success"]
										? pe.a.set(this.cookieName, "opened", { path: "/", expires: 200 })
						...
						closePopUp: function (e) {
							if ((e && e.stopPropagation(), (this.show = !1), this.selected))
								pe.a.remove(this.cookieName, { path: "/" });
							else {
								var n = this.frequency;
								pe.a.set(t, "opened", { path: "/", expires: n });
							}
						},
					};
				};
									...
									.then(function (t) {
										...
										document.getElementById("main-cart-footer").classList.toggle("hidden", 0 === r.item_count),
											i.getSectionsToRender().forEach(function (e) {
												...
												).innerHTML = i.getSectionInnerHTML(r.sections[e.section], e.selector);
											}),
							...
							updateLiveRegions: function (e, t) {
								this.currentItemCount === t
									? ((document
									  ...
									  document.getElementById("Line-item-error-".concat(e)).classList.remove("hidden"))
									: document.querySelectorAll(".cart-item-error").forEach(function (e) {
											e.classList.add("hidden");
									  });
								(this.currentItemCount = t), this.lineItemStatusElement.setAttribute("aria-hidden", !0);
		...
		console.log("".concat("Baseline", " ").concat("2.0.12", " by Switch Themes – https://switchthemes.co")), g("*");
	},
]);
