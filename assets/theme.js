/******/ (function (modules) {
	...
	/******/ function jsonpScriptSrc(chunkId) {
		/******/ return (
			...
			"assets/" +
			({ 1: "product-image-zoom", 5: "vendors--product-image-zoom" }[chunkId] || chunkId) +
			".min.js"
		);
		/******/
	}
   ...
   // */
							...
							/* harmony default export */ const elements_slide = function (Splide, index, realIndex, slide) {
								...
								var STATUS_UPDATE_EVENTS =
									"ready.slide updated.slide resized.slide moved.slide" + (updateOnMove ? " move.slide" : "");
								/**
									...
									if (absV > 0) {
										...
										if (!Splide.is(FADE)) {
											...
											if (
												...
												destination +=
													sign *
													Math.min(absV * options.flickPower, Components.Layout.size * (options.flickMaxPages || 1));
											}
								...
								var Lazyload = {
									...
									mount: function mount() {
										Splide.on("mounted refresh", function () {
											...
											Components.Elements.each(function (Slide) {
												each(
													Slide.slide.querySelectorAll("[" + SRC_DATA_NAME + "], [" + SRCSET_DATA_NAME + "]"),
													function (img) {
							...
							e.exports = (function () {
								...
								function i(e, i) {
									...
									if (f && h) {
										var l = f.split(".").map(r),
											p = h.split(".").map(r);
										for (a = 0; a < Math.max(l.length, p.length); a++) {
											if (void 0 === l[a] || ("string" == typeof p[a] && "number" == typeof l[a])) return -1;
											if (void 0 === p[a] || ("string" == typeof l[a] && "number" == typeof p[a])) return 1;
											if (l[a] > p[a]) return 1;
											if (p[a] > l[a]) return -1;
										}
					...
					a = function (e, t) {
						return (
							Object.entries(e).forEach(function (r) {
								var n = r[0],
									c = r[1];
								i(c) || (!s(c) && !o(c)) || (e[n] = a(c, t));
							}),
							new Proxy(e, {
								get: function (e, r, n) {
									return t.get(e, r, n);
								},
								set: function (e, r, n, c) {
									i(n) || (!s(n) && !o(n)) || (n = a(n, t));
									var u = e[r];
									return (
										(e[r] = n), i(u) || i(u.__watchers) || (e[r].__watchers = u.__watchers), t.set(e, r, e[r], c), !0
									);
								},
							})
						);
					...
					c = {
						...
						start: function () {
							...
							this.startingCallbacks.forEach(function (e) {
								...
								this.attach(),
								(this.stores = a(this.stores, {
									get: function (t, r, n) {
										return Object.is(n, e.stores) && ["get", "set", "toggle", "call", "clear"].includes(r)
											? e[r].bind(e)
											: Reflect.get(t, r, n);
									},
						...
						attach: function () {
							if (
								!(
									...
									(window.Alpine && n.compare(window.Alpine.version, "2.7.0", ">="))
								)
							)
						...
						updateLocalStorage: function (r) {
							...
							delete n.__watchers,
								delete n.__key_name,
								this.persistenceDriver.setItem("__spruce:" + r, JSON.stringify(this.store(r)));
						},
						get: function (e, t) {
							return (
						...
						set: function (e, t, r) {
							return (
								void 0 === r && (r = this.stores),
								o(e) || (e = e.split(".")),
								1 === e.length
									? (r[e[0]] = t)
									: r[e[0]]
									? this.set(e.slice(1), t, r[e[0]])
									: ((r[e[0]] = {}), this.set(e.slice(1), t, r[e[0]]))
							);
						},
						toggle: function (e) {
						...
						watch: function (e, t) {
							...
							var n = e.split("."),
								a = n.reduce(function (e, t) {
									var r = e[t];
									return i(r) || (!s(r) && !o(r)) ? e : r;
								}, this.stores),
								c = Object.is(a, this.get(e)) ? "__self" : n[n.length - 1];
							return (
								a.__watchers || (a.__watchers = new Map()),
								a.__watchers.has(c) || a.__watchers.set(c, new Set()),
								a.__watchers.get(c).add(t),
								[
									function () {
										return r.unwatch(e, t);
									},
						...
						unwatch: function (e, t) {
							var r = e.split("."),
								...
								a = Object.is(n, this.get(e)) ? "__self" : r[r.length - 1],
								c = n.__watchers;
							c.has(a) && c.get(a).delete(t);
						},
						watchers: function (e) {
							var t = e.split("."),
								...
								n = Object.is(r, this.get(e)) ? "__self" : t[t.length - 1];
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			function getImageSrcset(
				src,
				sizes = [180, 360, 540, 720, 900, 1080, 1296, 1512, 1728, 1944, 2160, 2376, 2592, 2808, 3024]
			) {
				if (!src) return;
			...
			function headerIsActive() {
				return document.querySelector(".site-header").classList.contains("active") || false;
			}
			...
			function initAlpineComponent(functionName) {
				...
				document.querySelectorAll(`[data-alpinejs-component="${functionName}()"`).forEach((el) => {
...
*/
			...
			window["ThemeComponent_PopUp"] = function () {
				return {
					...
					openModal: function openModal() {
						...
						setTimeout(function () {
							trapFocus(_this2.$refs.modal);

							_this2.$refs.close.focus();
						}, 300);
					},
			...
			window["ThemeComponent_Video"] = function (id, type, host, autoplay) {
				return {
					enabled: false,
					id: id,
					type: type,
			...
			register("header", {
				onLoad: function onLoad() {
					...
					document.documentElement.style.setProperty(
						"--header-height",
						"".concat(this.container.clientHeight + announcementBar.clientHeight, "px")
					);
					...
					window[functionName] = function () {
						return {
							...
							searchFocusOut: function searchFocusOut(event) {
								if (event.relatedTarget) {
									var searchParent = event.relatedTarget.closest("[data-header-search]");
			...
			var currency_cjs = __webpack_require__(4);

			// EXTERNAL MODULE: ./node_modules/@shopify/theme-images/dist/images.cjs.js
			var images_cjs = __webpack_require__(2);
			...
			function ProductForm(element, product, options) {
				...
				this.optionInputs = this._initInputs(theme_product_form_selectors.optionInput, options.onOptionChange);

				this.quantityInputs = this._initInputs(theme_product_form_selectors.quantityInput, options.onQuantityChange);

				this.propertyInputs = this._initInputs(theme_product_form_selectors.propertyInput, options.onPropertyChange);
			}
			...
			var splide_esm = __webpack_require__(5);
    ...
    */
					...
					fetchContent: function (variant) {
						...
						if (window.Spruce.store("availability").availability[variant.id]) {
							...
							const variantSectionUrl =
								this.container.dataset.baseUrl + "/variants/" + variant.id + "/?section_id=store-availability";
			...
			register("product", {
				onLoad: function onLoad() {
					...
					this.selectedVariantObject = JSON.parse(
						this.container.querySelector("[data-selected-variant-json]").innerHTML
					);
					...
					if (this.enableImageZoom) {
						Promise.all(/* import() | product-image-zoom */ [__webpack_require__.e(5), __webpack_require__.e(1)])
							.then(__webpack_require__.bind(null, 39))
							.then(function (_ref) {
					...
					window.addEventListener("DOMContentLoaded", function (event) {
						document.documentElement.style.setProperty(
							"--add-to-cart-height",
							"".concat(addToCartBtn.offsetHeight, "px")
						);
					});
					...
					window[functionName] = function () {
						return {
							...
							getOptions: function getOptions() {
								...
								selectors.forEach(function (selector) {
									if (selector.nodeName === "SELECT") {
										...
										_this2.options.push(value);

										_this2.optionHandles.push(selector.options[selector.selectedIndex].dataset.handle);
									} else {
										if (selector.checked) {
											var _value = selector.value;

											_this2.options.push(_value);

											_this2.optionHandles.push(selector.dataset.handle);
										}
									}
								});
							},
							swapVariantImage: function swapVariantImage() {
								//const currentFirstMediaHTML = this.$refs.firstMedia.innerHTML;
								var currentFirstMediaHTML = document.querySelector("[data-first-media]").innerHTML;
								var nextVariantMediaHTML = document
									.querySelector('[data-media-id="' + this.current_variant.featured_media.id + '"]')
									.closest(".product-media-height").outerHTML;
								document
									.querySelector('[data-media-id="' + this.current_variant.featured_media.id + '"]')
									.closest("li").innerHTML = currentFirstMediaHTML;
							...
							scrollToVariantImage: function scrollToVariantImage() {
								var stickyHeader = document
								...
								if (section.slides && section.slides.classList.contains("is-active")) {
									...
									var offset = window.pageYOffset + featuredMedia.getBoundingClientRect().top - additionalOffset;
									window.scroll(
										_objectSpread(
											{
												top: offset,
							...
							submitForm: function submitForm(evt) {
								...
								addItemFromForm(this.$refs.productForm)
									.then(function (item) {
										_this3.loading = false;
										_this3.addedToCart = true;
							...
							openZoom: function openZoom(index) {
								var items = window.matchMedia("(max-width: 767px)").matches
									? section.mobilePswpItems
									: section.desktopPswpItems;
								section.pswpOptions.index = index;
								var gallery = new section.PhotoSwipe(
									section.pswpElement,
									section.PhotoSwipeUI_Default,
									items,
									section.pswpOptions
								);
								gallery.init();
								...
								gallery.listen("destroy", function () {
									...
									var elToRefocus = section.container.querySelector(
										'[data-product-image-index="'.concat(indexToRefocus, '"]')
									);
				...
				setupSlideshow: function setupSlideshow(isHorizontalGalleryTemplate) {
							...
							breakpoints: {
								1024: {
									...
									classes: {
										...
										pagination:
											"splide__pagination splide__pagination--product flex justify-start items-center mt-4 ml-1 w-auto", // container
									},
								},
							},
						};
				...
				setUpImageZoom: function setUpImageZoom(PhotoSwipe, PhotoSwipeUI_Default) {
					...
					var mediaOrder = [];
					var mediaElsInPage = this.container
					...
					var imageDataInOrder = [];

					for (var _i = 0, _mediaOrder = mediaOrder; _i < _mediaOrder.length; _i++) {
						var mediaId = _mediaOrder[_i];
					...
					for (var _i2 = 0, _imageDataInOrder = imageDataInOrder; _i2 < _imageDataInOrder.length; _i2++) {
						var productImage = _imageDataInOrder[_i2];
						...
						if (imageFullSizeWidth <= desktopMaxWidth) {
							...
							var desktopSizedImgUrl = Object(images_cjs["getSizedImageUrl"])(
								imageFullSizeUrl,
								"".concat(desktopMaxWidth, "x")
							);
			...
			function _toConsumableArray(arr) {
				return (
					...
					collection_unsupportedIterableToArray(arr) ||
					_nonIterableSpread()
				);
			}
			...
			function collection_unsupportedIterableToArray(o, minLen) {
				if (!o) return;
				if (typeof o === "string") return collection_arrayLikeToArray(o, minLen);
				var n = Object.prototype.toString.call(o).slice(8, -1);
				if (n === "Object" && o.constructor) n = o.constructor.name;
				if (n === "Map" || n === "Set") return Array.from(o);
				if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))
			...
			function _arrayWithoutHoles(arr) {
				if (Array.isArray(arr)) return collection_arrayLikeToArray(arr);
			}
						...
						return {
							...
							renderPage: function renderPage(searchParams, event) {
								...
								sections.forEach(function (section) {
									...
									_this2.filterData.some(filterDataUrl)
										? _this2.renderSectionFromCache(filterDataUrl, event)
										: _this2.renderSectionFromFetch(url, event);
								});
							...
							renderFilters: function renderFilters(html) {
								...
								var innerHTML = parsedHTML.getElementById("CollectionFiltersForm").innerHTML;
			...
			function cart_ownKeys(object, enumerableOnly) {
				var keys = Object.keys(object);
				if (Object.getOwnPropertySymbols) {
					var symbols = Object.getOwnPropertySymbols(object);
					if (enumerableOnly)
			...
			function cart_objectSpread(target) {
				for (var i = 1; i < arguments.length; i++) {
					var source = arguments[i] != null ? arguments[i] : {};
					if (i % 2) {
						cart_ownKeys(Object(source), true).forEach(function (key) {
							cart_defineProperty(target, key, source[key]);
						});
					} else if (Object.getOwnPropertyDescriptors) {
						Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));
					} else {
						cart_ownKeys(Object(source)).forEach(function (key) {
							Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
						});
					}
				}
			...
			function cart_defineProperty(obj, key, value) {
				if (key in obj) {
					Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });
				} else {
					obj[key] = value;
						...
						return {
							...
							mounted: function mounted() {
								...
								this.currentItemCount = Array.from(
									document.getElementById("main-cart-items").querySelectorAll('[name="updates[]"]')
								).reduce(function (total, quantityInput) {
									return total + parseInt(quantityInput.value);
								}, 0);
								var debouncedOnChange = debounce_default()(function (event) {
							...
							updateQuantity: function updateQuantity(line, quantity, name) {
								var _this2 = this;
								...
								fetch(
									...
									.then(function (state) {
										...
										_this2.getSectionsToRender().forEach(function (section) {
											...
											elementToReplace.innerHTML = _this2.getSectionInnerHTML(
												parsedState.sections[section.section],
												section.selector
											);
										});

										document.getElementById("CartCount").textContent = parsedState.item_count;
										document.getElementById("main-cart-items").classList.remove("opacity-10");
										document
											.getElementById("CartItem-".concat(line))
											.querySelector('[name="'.concat(name, '"]'))
											.focus();
							...
							updateLiveRegions: function updateLiveRegions(line, itemCount) {
								if (this.currentItemCount === itemCount) {
									document
										.getElementById("Line-item-error-".concat(line))
										.querySelector(".cart-item-error-text").innerHTML = window.theme.strings.cartQuantityError.replace(
										"[quantity]",
										document.getElementById("Quantity-".concat(line)).value
									);
									document.getElementById("Line-item-error-".concat(line)).classList.remove("hidden");
								} else {
									var cartErrors = document.querySelectorAll(".cart-item-error");
